...
class SStudent(BaseModel):
    ...
    password: str = Field(..., min_length=3, max_length=16, description="Пароль должен быть в диапазоне от 3 до 32 символов")
    ...
    klass: int = Field(..., ge=1, le=5, description="Класс должен быть в диапазоне от 1 до 11")
    school: str
